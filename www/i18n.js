...
// ── DISCLAIMER / TERMINI DI UTILIZZO ─────────────────────────────
  ...
  disclaimer_section_ads_body:         {  it: "Questa app può mostrare annunci pubblicitari forniti da Google AdMob (Google Ireland Limited). Google e i suoi partner pubblicitari possono utilizzare identificatori del dispositivo e tecnologie simili per mostrare annunci personalizzati, in conformità con le proprie policy sulla privacy. L'utente può gestire le preferenze sugli annunci personalizzati nelle impostazioni del proprio dispositivo Android (Impostazioni > Google > Annunci) o visitando adssettings.google.com. Continuando a utilizzare l'app, l'utente acconsente all'utilizzo di tali tecnologie da parte di Google nei limiti consentiti dalla normativa applicabile.",
                                          en: "This app may display advertisements provided by Google AdMob (Google Ireland Limited). Google and its advertising partners may use device identifiers and similar technologies to show personalized ads, in accordance with their own privacy policies. You can manage personalized ad preferences in your Android device settings (Settings > Google > Ads) or by visiting adssettings.google.com. By continuing to use the app, you consent to the use of these technologies by Google to the extent permitted by applicable law." },
